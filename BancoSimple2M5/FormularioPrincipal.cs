...
<<<<<<< HEAD
        // Evento que se ejecuta al hacer clic en el bot�n "Agregar Cuenta".
        // Verifica si hay un cliente seleccionado en el DataGridView, abre el formulario para agregar una nueva cuenta
        // y si el usuario confirma la acci�n, guarda la nueva cuenta en la base de datos.
=======
...
<<<<<<< HEAD
                return;// Si no hay selecci�n, detiene la ejecuci�n.
            }
            ...
            // Crea e instancia el formulario para agregar cuentas, pasando el ID del cliente como par�metro.
            var formAgregarCuentas = new AgregarCuentasForm(clienteId);

            // Muestra el formulario como un cuadro de di�logo modal.
=======
...
>>>>>>> 8f9a76ca8239dd6aba497567d83ed1a1f426b787
            if (formAgregarCuentas.ShowDialog() == DialogResult.OK)
            {
                ...
                {
<<<<<<< HEAD
                    // Si el usuario confirm� (OK), agrega la nueva cuenta al contexto de base de datos.
...
>>>>>>> 8f9a76ca8239dd6aba497567d83ed1a1f426b787
                ...
                {
<<<<<<< HEAD
                    // Muestra un mensaje de error si ocurre una excepci�n durante el guardado.
=======
